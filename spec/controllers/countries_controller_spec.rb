...
# This spec was generated by spec-rails when you ran the scaffold generator.
...
#
# It only uses APIs available in rails and/or spec-rails.  There are a number
# of tools you can use to make these specs even more expressive, but we're
# sticking to rails and spec-rails APIs to keep things simple and stable.
#
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved country as @country" do
        ...
        post :create, {:country => { "title" => "invalid value" }}, valid_session
        assigns(:country).should be_a_new(Country)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested country" do
        ...
        Country.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => country.to_param, :country => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the country as @country" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Country.any_instance.stub(:save).and_return(false)
        put :update, {:id => country.to_param, :country => { "title" => "invalid value" }}, valid_session
        assigns(:country).should eq(country)
      end
